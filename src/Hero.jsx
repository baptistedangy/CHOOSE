  ...
  >
    ...
    >
      ...
      <div className="relative bg-gradient-to-r from-black/80 to-transparent rounded-3xl backdrop-blur-sm p-8 md:p-10 w-fit max-w-full ml-4 sm:ml-8 md:ml-16">
        <h1 className="text-[#FFFFFF] text-5xl md:text-6xl font-bold font-sans drop-shadow-lg leading-relaxed pl-4 md:pl-8">
          Bien manger, sans hésiter.
        </h1>
        <p className="text-[#FFFFFF] text-lg md:text-xl font-sans leading-relaxed drop-shadow-lg mt-4 md:mt-6 pl-4 md:pl-8">
          L'assistant qui t'aide à choisir le plat parfait, pour ton corps et tes envies, à chaque resto.
        </p>
        <button
          onClick={onCtaClick}
          className="bg-white text-[#4F46E5] font-semibold rounded-full py-4 text-lg md:py-6 md:text-2xl shadow-xl transition-all duration-200 mt-6 md:mt-8 hover:bg-[#4F46E5] hover:text-white px-0 md:px-0 pl-4 md:pl-8"
        >
